        ...
        switch (_a.label) {
            case 0:
                ...
                if (process.argv.length === 2) {
                    child_process_1.execSync('troila-mobile -h');
                }
                if (!utils_1.compareVersion(nodeVersion)) {
                ...
                return [4 /*yield*/, utils_1.setProjectName()];
            case 1:
                projectName = _a.sent();
                return [3 /*break*/, 4];
            case 2:
            ...
            case 3:
                projectName = _a.sent();
                _a.label = 4;
            case 4: return [4 /*yield*/, utils_1.mode()];
            case 5:
                reactMode = _a.sent();
                projectName = projectName || global['projectName'];
                fs.mkdirSync(projectName);
                currentPath = path.resolve(__dirname, '..');
                directory = currentPath + utils_1.type(reactMode.flag);
